...
This project is indexed by GitNexus as **tinkaria** (3621 symbols, 10740 relationships, 287 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/tinkaria/process/{processName}` — trace the full execution flow step by step
