...
| Personal runners | Per-user `tinkaria-runner` over Tailscale; own Claude account/git identity/secrets; 8 epics PR1–PR8 — `personal-runners/change-request.md`. PR1 (secure NATS transport+isolation) implemented; PR2 (runner identity & pairing, ownerId deferred) in progress | in_progress |
